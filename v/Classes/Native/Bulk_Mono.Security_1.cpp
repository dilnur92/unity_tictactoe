...
IL_00b4:
	{
		...
		X509Certificate__ctor_m1_3625(L_28, L_27, /*hidden argument*/NULL);
		V_6 = L_28;
...
IL_0068:
	{
		...
		Encoding_t1_218 * L_21 = Encoding_get_UTF8_m1_4244(NULL /*static, unused*/, /*hidden argument*/NULL);
		ASN1_t3_2 * L_22 = V_4;
		NullCheck(L_22);
...
extern "C" void TlsServerFinished_ProcessAsTls1_m3_849 (TlsServerFinished_t3_107 * __this, const MethodInfo* method)
{
	...
	ByteU5BU5D_t1_70* V_4 = {0};
	{
		...
		NullCheck(L_8);
		NullCheck(L_6);
		ByteU5BU5D_t1_70* L_9 = HashAlgorithm_ComputeHash_m1_3763(L_6, L_7, 0, (((int32_t)((int32_t)(((Array_t *)L_8)->max_length)))), /*hidden argument*/NULL);
		V_3 = L_9;
...
extern "C" void TlsServerHello_Update_m3_851 (TlsServerHello_t3_108 * __this, const MethodInfo* method)
{
	...
	ByteU5BU5D_t1_70* V_4 = {0};
	{
		...
		int32_t L_20 = V_0;
		Buffer_BlockCopy_m1_4572(NULL /*static, unused*/, (Array_t *)(Array_t *)L_18, 0, (Array_t *)(Array_t *)L_19, 0, L_20, /*hidden argument*/NULL);
		...
		int32_t L_24 = V_0;
		int32_t L_25 = V_1;
		Buffer_BlockCopy_m1_4572(NULL /*static, unused*/, (Array_t *)(Array_t *)L_22, 0, (Array_t *)(Array_t *)L_23, L_24, L_25, /*hidden argument*/NULL);
		...
		int32_t L_32 = V_1;
		Buffer_BlockCopy_m1_4572(NULL /*static, unused*/, (Array_t *)(Array_t *)L_30, 0, (Array_t *)(Array_t *)L_31, 0, L_32, /*hidden argument*/NULL);
		...
		int32_t L_36 = V_1;
		int32_t L_37 = V_0;
		Buffer_BlockCopy_m1_4572(NULL /*static, unused*/, (Array_t *)(Array_t *)L_34, 0, (Array_t *)(Array_t *)L_35, L_36, L_37, /*hidden argument*/NULL);
...
extern "C" void TlsServerKeyExchange_verifySignature_m3_862 (TlsServerKeyExchange_t3_110 * __this, const MethodInfo* method)
{
	...
	bool V_3 = false;
	{
		...
		NullCheck(L_12);
		HashAlgorithm_ComputeHash_m1_3762(L_12, L_14, /*hidden argument*/NULL);
